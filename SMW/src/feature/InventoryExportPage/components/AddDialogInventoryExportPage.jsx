...
import { INVENTORY_EXPORT_ITEM_DEFAULT_VALUES } from "../constants/constants";
import useInventoryExportPageAddSchema from "../validations/inventory-export-add-item";

// eslint-disable-next-line react/prop-types
const AddDialogInventoryExportPage = ({
  open,
  isLoading,
  onSubmit,
  onClose,
  ...
  const methods = useForm({
    resolver: zodResolver(useInventoryExportPageAddSchema()),
    defaultValues: INVENTORY_EXPORT_ITEM_DEFAULT_VALUES,
  });
...
export default AddDialogInventoryExportPage;
